const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Home-BCAmL3yi.js","assets/blogs-CX3biqOy.js","assets/classes-BXoKJlax.js","assets/testimonials-DdCDQAc1.js","assets/arrow-right-cHCxvTw0.js","assets/clock-D6q3ay0j.js","assets/About-VuC-8q-Y.js","assets/Classes-DAHGbe_M.js","assets/Trainers-CRqqPxvX.js","assets/Membership-DJbI6Rb0.js","assets/check-BGj_zr2g.js","assets/Testimonials-CY_EDFxW.js","assets/Blog-CY2B7f2G.js","assets/BlogPost-CaBBEz9v.js","assets/Contact-C2EnDM-A.js"])))=>i.map(i=>d[i]);
...
const Dumbbell = createLucideIcon("dumbbell", __iconNode$9);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function Footer() {
  ...
  const hostname = typeof window !== "undefined" ? window.location.hostname : "thegyms.in";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "bg-card border-t border-border", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-primary", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 md:px-8 py-8 flex flex-col md:flex-row items-center justify-between gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-black text-xl text-primary-foreground tracking-wider uppercase", children: "Ready to Transform?" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary-foreground/80 text-sm", children: "Join 2,000+ members already crushing their goals at The Gyms." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Link,
        {
          ...
          children: "View Plans — Starting ₹1,499"
        }
      )
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 md:px-8 py-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-2 mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 bg-primary flex items-center justify-center font-display font-black text-sm text-primary-foreground", children: "TG" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-black text-xl tracking-wider text-foreground", children: "THE GYMS" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm leading-relaxed mb-6 max-w-xs", children: "India's premier fitness destination. We don't just build bodies — we forge champions. Premium equipment, world-class trainers, and a culture of excellence." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2.5 text-sm text-muted-foreground", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-start gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-3 mt-6", children: social.map(({ icon: Icon2, href, label }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              href,
              target: "_blank",
        ...
        Object.entries(footerLinks).map(([title, links]) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-xs tracking-widest text-secondary uppercase mb-4", children: title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "flex flex-col gap-2", children: links.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Link,
            {
              to: link.to,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-12 pt-6 border-t border-border/50 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-muted-foreground", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Dumbbell, { size: 12, className: "text-primary" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
            "© ",
            year,
            " The Gyms. All rights reserved."
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
...
function Navbar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden md:flex items-center justify-between px-8 py-2 bg-card border-b border-border/50 text-xs text-muted-foreground", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { size: 11, className: "text-primary" }),
          "+91 98765 43210"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Open Mon–Sat: 5am–11pm | Sun: 6am–8pm" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(Instagram, { size: 13 })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            ...
            "aria-label": "YouTube",
            className: "hover:text-secondary transition-smooth",
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(Youtube, { size: 13 })
          }
        )
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "header",
      {
        className: `sticky top-0 z-50 transition-smooth ${scrolled ? "bg-background/95 backdrop-blur-md border-b border-border shadow-elevated" : "bg-card border-b border-border/60"}`,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "max-w-7xl mx-auto px-4 md:px-8 h-16 flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Link,
              {
                to: "/",
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 bg-primary flex items-center justify-center font-display font-black text-sm text-primary-foreground rotate-0 group-hover:rotate-3 transition-smooth", children: "TG" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-black text-xl tracking-wider text-foreground group-hover:text-primary transition-smooth", children: "THE GYMS" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "hidden lg:flex items-center gap-1", children: navLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Link,
              {
                to: link.to,
                "data-ocid": `navbar.link.${link.label.toLowerCase()}`,
                className: `relative px-3 py-2 text-sm font-medium tracking-wide transition-smooth ${isActive(link.to) ? "text-primary" : "text-muted-foreground hover:text-foreground"}`,
                children: [
                  link.label,
                  isActive(link.to) && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute bottom-0 left-3 right-3 h-0.5 bg-primary" })
                ]
              }
            ) }, link.to)) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: `lg:hidden overflow-hidden transition-all duration-300 ease-in-out ${isOpen ? "max-h-screen" : "max-h-0"}`,
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border-t border-border/50 px-4 py-4 flex flex-col gap-1", children: [
                navLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Link,
                  {
                    to: link.to,
                    "data-ocid": `navbar.mobile.${link.label.toLowerCase()}`,
                    className: `px-4 py-3 text-sm font-medium tracking-wide transition-smooth border-l-2 ${isActive(link.to) ? "text-primary border-primary bg-primary/5" : "text-muted-foreground border-transparent hover:text-foreground hover:border-border"}`,
                    children: link.label
                  },
                  link.to
                )),
...
function PageTransition({ children }) {
  ...
  const pathnameRef = reactExports.useRef(pathname);
  reactExports.useEffect(() => {
    var _a2;
    if (pathnameRef.current === pathname && ((_a2 = containerRef.current) == null ? void 0 : _a2.style.opacity) === "1")
      return;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: containerRef, style: { opacity: 0 }, children });
}
function Layout({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-background text-foreground", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx(PageTransition, { children }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Footer, {})
  ] });
}
const Home = reactExports.lazy(() => __vitePreload(() => import("./Home-BCAmL3yi.js"), true ? __vite__mapDeps([0,1,2,3,4,5]) : void 0));
const About = reactExports.lazy(() => __vitePreload(() => import("./About-VuC-8q-Y.js"), true ? __vite__mapDeps([6,4]) : void 0));
const Classes = reactExports.lazy(() => __vitePreload(() => import("./Classes-DAHGbe_M.js"), true ? __vite__mapDeps([7,2,5,4]) : void 0));
const Trainers = reactExports.lazy(() => __vitePreload(() => import("./Trainers-CRqqPxvX.js"), true ? __vite__mapDeps([8,4]) : void 0));
const Membership = reactExports.lazy(() => __vitePreload(() => import("./Membership-DJbI6Rb0.js"), true ? __vite__mapDeps([9,10,4]) : void 0));
const Testimonials = reactExports.lazy(() => __vitePreload(() => import("./Testimonials-CY_EDFxW.js"), true ? __vite__mapDeps([11,3,4]) : void 0));
const Blog = reactExports.lazy(() => __vitePreload(() => import("./Blog-CY2B7f2G.js"), true ? __vite__mapDeps([12,1,5]) : void 0));
const BlogPost = reactExports.lazy(() => __vitePreload(() => import("./BlogPost-CaBBEz9v.js"), true ? __vite__mapDeps([13,1,5]) : void 0));
const Contact = reactExports.lazy(() => __vitePreload(() => import("./Contact-C2EnDM-A.js"), true ? __vite__mapDeps([14,5,10]) : void 0));
const PageLoader = () => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center h-64", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
  "div",
  {
    ...
    children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground tracking-widest uppercase font-display", children: "Loading" })
    ]
  }
) });
