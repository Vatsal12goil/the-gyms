  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        "red-glow": "0 0 30px rgba(220, 38, 38, 0.25), 0 0 60px rgba(220, 38, 38, 0.1)",
        "gold-glow": "0 0 20px rgba(253, 176, 34, 0.3)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
      ...
      animation: {
        ...
        "page-in": "page-in 0.4s cubic-bezier(0.4, 0, 0.2, 1) both",
